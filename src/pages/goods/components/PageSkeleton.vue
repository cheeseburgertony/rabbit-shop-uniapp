  ...
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport viewport" :enable-back-to-top="true">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-337 sk-text">128.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-444 sk-text"
            >钻石陶瓷涂层多用锅18cm 小奶锅</view
          >
          <view class="desc sk-transparent sk-text-0-0000-676 sk-text">安全耐用，易于清洗APP</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-873 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-466 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-537 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-87 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-978 sk-text">服务</text>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-568 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-368 sk-text">额定电压功率</text>
              <text class="value sk-transparent sk-text-25-0000-722 sk-text"
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-20 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-676 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
